...
##Usage
[Click here](my_planets_probabili.py) to use a 2-D interpolant that takes in the radius of a planet, its orbital period, and the number of planets in its system with period less than 13.7 days. Simply pull up a command line and type: python my_planets_probabili.py.
